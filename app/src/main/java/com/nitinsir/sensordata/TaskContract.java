...
public class TaskContract {
    ...
    public static final String AUTHORITY = "com.sensorData.data";
    ...
    public static final class TaskEntry implements BaseColumns {
        ...
        public static final String COLUMN_R = "rcolor";
        public static final String COLUMN_G = "gcolor";
        public static final String COLUMN_B= "bcolor";
